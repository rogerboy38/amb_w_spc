...
function show_pipeline_overview(frm) {
    frappe.call({
        method: 'amb_w_spc.amb_w_spc.sfc_manufacturing.doctype.batch_amb.batch_amb.get_pipeline_overview',
        args: { batch_name: frm.doc.name },
        callback: function(r) {
            if (r.message) {
...
function view_batch_tree(frm) {
    frappe.call({
        method: 'amb_w_spc.amb_w_spc.sfc_manufacturing.doctype.batch_amb.batch_amb.get_batch_tree_html',
        args: { batch_name: frm.doc.name },
        callback: function(r) {
            if (r.message) {
                const d = new frappe.ui.Dialog({
